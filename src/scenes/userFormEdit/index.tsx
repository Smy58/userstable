...
const UserForm = () => {
	...
	const currentUser = users.find((item) => userId === item.id)
	...
	const [skills, setSkills] = useState<skillType[]>(currentUser?.skills || [])
		...
		<Box m="20px">
			...
			<form onSubmit={handleSubmit(onSubmit)} noValidate>
				...
				<Box display="flex" justifyContent="end" mt="20px">
					<Button onClick={() => onDelete()} color="error" variant="contained" sx={{ marginRight: "20px"}}>
						Delete
					</Button>
